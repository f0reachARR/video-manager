...
- UUID、timestamp、duration、offset、enum は schema で明示する
...
- 抽出できなかった場合は UI から手で recorded_at を補正できる
...
- Run の score / memo / robot / scenario / tags を編集できる
...
- tags
- memo
- Marker category（成功 / 失敗 / note などで絞り込み）
